...
export default class DocsMenu extends React.Component {
    render() {
        ...
        return (
            <nav id="testdocs-nav" className="testdocs-nav">
              <div id="testdocs-nav-inside" className="testdocs-nav-inside sticky">
                <button id="testdocs-nav-toggle" className="testdocs-nav-toggle">Navigate Docs<span className="icon-angle-right" aria-hidden="true" /></button>
                <div className="testdocs-toc-wrap">
                  <ul id="testdocs-toc" className="testdocs-toc">
